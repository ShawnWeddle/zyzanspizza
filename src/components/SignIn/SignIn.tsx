...
const SignInForm: React.FC = () => {
  ...
  return (
    <div className="mt-4 flex w-full grow justify-center">
      <div className="h-min w-full bg-gradient-to-b from-green-700 to-green-800 sm:max-w-screen-sm sm:rounded-lg md:max-w-screen-md">
